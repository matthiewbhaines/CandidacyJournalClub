...
- ![Figure 1](https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-018-5058-2/figures/1)  
  + 1A: spread on y axis, not on x axis
    + only T1 (y axis) is associated iwth variant (non-pleiotropic)
    + better separation seen in 2D (practice with the pencil test from high school math class)
  + 1B: spread on y and x asis
    + minor allele has opposing effects, $\uparrow$ T1 (Y) and $\downarrow$ T2 (X)
    + starting to see the spead on y and x axes, especially when combined
  + 1C: minor allele has similar effects, $\uparrow$ T1 (Y) and $\uparrpw$ T2 (X)
