...
- This used a white European population
  + other races/ethnicites will have different genetic variances

## Bitter is not a simple taste
:::::::::::::: {.columns}
:::{.column}
- So far, ~25 bitter taste receptors (TAS2R's) have been identified^10^
- Not every compound activates the same receptor
:::
::: {.column}
```{r}
library(readxl)
...
kable(Meyerhof2010AgonistTable, caption = "#, previously known agonist confirmed in the present study; §, previously known agonist not confirmed in the present study")
```
:::
::::::::::::::

## Coffee is not simple, either
- Caffeine predicts 10-33% of the bitterness in coffee (Guo, French paper)
